...
(function($) {
	...
	if ($('.banner-slider').length) {
		// On crée une instance Swiper et on la met sur `window` pour pouvoir y accéder depuis d'autres scripts si besoin
		window.bannerSlider = new Swiper('.banner-slider', {
			modules: [Navigation, Autoplay, EffectFade], // modules nécessaires
			slidesPerView: 1,
			loop: true,
			speed: 1000,
			effect: 'fade',
